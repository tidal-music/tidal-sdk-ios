...
### Changed
- Generated API code using spec version 1.10.105 (TidalAPI)
...
### Changed
- Generated API code using spec version 1.10.89 (TidalAPI)
...
### Changed
- Generated API code using spec version 1.1.39 (TidalAPI)

## [0.11.4] - 2026-02-19

### Changed
- Generated API code using spec version 1.1.36 (TidalAPI)
...
### Changed
- Generated API code using spec version 1.1.32 (TidalAPI)


### Changed
- Generated API code using spec version 1.1.19 (TidalAPI)

## [0.11.1] - 2026-02-11

### Added
- Added `PreviewReason` enum to indicate why a track is being played as a preview (Player)
- Added `previewReason` field to `PlaybackContext` to expose preview reason information from Track Manifests API, enabling apps to distinguish between subscription-required previews, purchase-required previews, and higher-tier-required previews (Player)

## [0.11.0] - 2026-02-10

### Changed
- Generated API code using spec version 1.1.11 (TidalAPI)
