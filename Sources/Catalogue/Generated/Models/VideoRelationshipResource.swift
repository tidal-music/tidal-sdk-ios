...
public struct VideoRelationshipResource: Codable, Hashable {

    public var attributes: VideoRelationship?
    ...
    public init(attributes: VideoRelationship? = nil, relationships: [String: Relationship]? = nil, links: Links? = nil, id: String, type: String) {
