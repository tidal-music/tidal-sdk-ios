...
- **Formats** — dates, times and durations are ISO 8601 (`2024-05-01T12:00:00Z`, `PT3M5S`); countries ISO 3166-1 alpha-2; languages BCP 47; currencies ISO 4217; colors three- or six-digit hex (`#RGB` or `#RRGGBB`).
...
## Documentation For Models
 ...
 - [PlaylistGenerationsSingleRelationshipDataDocument](docs/PlaylistGenerationsSingleRelationshipDataDocument.md)
