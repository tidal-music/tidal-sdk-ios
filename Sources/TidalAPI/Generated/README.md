...
*UserSharesAPI* | [**userSharesGet**](docs/UserSharesAPI.md#usersharesget) | **GET** /userShares | Get multiple userShares.
*UserSharesAPI* | [**userSharesIdGet**](docs/UserSharesAPI.md#usersharesidget) | **GET** /userShares/{id} | Get single userShare.
*UserSharesAPI* | [**userSharesIdRelationshipsOwnersGet**](docs/UserSharesAPI.md#usersharesidrelationshipsownersget) | **GET** /userShares/{id}/relationships/owners | Get owners relationship (\&quot;to-many\&quot;).
*UserSharesAPI* | [**userSharesIdRelationshipsSharedResourcesGet**](docs/UserSharesAPI.md#usersharesidrelationshipssharedresourcesget) | **GET** /userShares/{id}/relationships/sharedResources | Get sharedResources relationship (\&quot;to-many\&quot;).
*UserSharesAPI* | [**userSharesPost**](docs/UserSharesAPI.md#usersharespost) | **POST** /userShares | Create single userShare.
