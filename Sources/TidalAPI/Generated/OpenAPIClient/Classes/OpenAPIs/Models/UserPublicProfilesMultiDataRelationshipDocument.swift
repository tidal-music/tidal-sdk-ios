//
// UserPublicProfilesMultiDataRelationshipDocument.swift
//
...
public struct UserPublicProfilesMultiDataRelationshipDocument: Codable, Hashable {
    ...
    public init(data: [ResourceIdentifier]? = nil, links: Links? = nil, included: [UserPublicProfilesMultiDataRelationshipDocumentIncludedInner]? = nil) {
        self.data = data
        self.links = links
