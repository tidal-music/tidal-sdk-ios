...
public struct PlaylistsAttributes: Codable, Hashable {
    ...
    public init(name: String, description: String? = nil, bounded: Bool, duration: String? = nil, numberOfItems: Int? = nil, externalLinks: [PlaylistsExternalLink], createdAt: Date, lastModifiedAt: Date, privacy: String, playlistType: String, imageLinks: [PlaylistsImageLink]) {
        self.name = name
