//
// SearchSuggestionsMultiDataDocumentIncludedInner.swift
//
...
public enum SearchSuggestionsMultiDataDocumentIncludedInner: Codable, JSONEncodable, Hashable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        if let value = try? container.decode(AlbumsResource.self) {
            ...
            throw DecodingError.typeMismatch(Self.Type.self, .init(codingPath: decoder.codingPath, debugDescription: "Unable to decode instance of SearchSuggestionsMultiDataDocumentIncludedInner"))
        }
    }
}

@available(iOS 13, tvOS 13, watchOS 6, macOS 10.15, *)
extension SearchSuggestionsMultiDataDocumentIncludedInner: Identifiable {
