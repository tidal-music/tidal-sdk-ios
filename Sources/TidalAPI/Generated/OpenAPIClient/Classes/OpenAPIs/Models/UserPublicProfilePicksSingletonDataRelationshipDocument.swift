//
// UserPublicProfilePicksSingletonDataRelationshipDocument.swift
//
...
public struct UserPublicProfilePicksSingletonDataRelationshipDocument: Codable, Hashable {
    ...
    public init(data: ResourceIdentifier? = nil, links: Links? = nil, included: [UserPublicProfilePicksSingletonDataRelationshipDocumentIncludedInner]? = nil) {
        self.data = data
        self.links = links
