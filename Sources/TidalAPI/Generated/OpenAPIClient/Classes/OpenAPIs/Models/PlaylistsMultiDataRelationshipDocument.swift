//
// PlaylistsMultiDataRelationshipDocument.swift
//
...
public struct PlaylistsMultiDataRelationshipDocument: Codable, Hashable {
    ...
    public init(data: [ResourceIdentifier]? = nil, links: Links? = nil, included: [PlaylistsMultiDataRelationshipDocumentIncludedInner]? = nil) {
        self.data = data
        self.links = links
