//
// SearchresultsMultiDataRelationshipDocument.swift
//
...
public struct SearchresultsMultiDataRelationshipDocument: Codable, Hashable {
    ...
    public init(data: [ResourceIdentifier]? = nil, links: Links? = nil, included: [SearchresultsMultiDataRelationshipDocumentIncludedInner]? = nil) {
        self.data = data
        self.links = links
