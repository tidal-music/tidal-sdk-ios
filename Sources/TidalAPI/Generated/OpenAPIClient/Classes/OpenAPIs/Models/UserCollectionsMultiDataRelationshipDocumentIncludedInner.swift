//
// UserCollectionsMultiDataRelationshipDocumentIncludedInner.swift
//
...
public enum UserCollectionsMultiDataRelationshipDocumentIncludedInner: Codable, JSONEncodable, Hashable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        } else if let value = try? container.decode(UserCollectionsResource.self) {
            self = .typeUserCollectionsResource(value)
        } else {
            throw DecodingError.typeMismatch(Self.Type.self, .init(codingPath: decoder.codingPath, debugDescription: "Unable to decode instance of UserCollectionsMultiDataRelationshipDocumentIncludedInner"))
        }
    }
}
...
extension UserCollectionsMultiDataRelationshipDocumentIncludedInner: Identifiable {}
