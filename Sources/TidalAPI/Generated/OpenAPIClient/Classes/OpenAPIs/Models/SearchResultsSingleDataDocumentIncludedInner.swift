...
// MARK: - SearchresultsSingleDataDocumentIncludedInner

public enum SearchresultsSingleDataDocumentIncludedInner: Codable, JSONEncodable, Hashable {
		...
		if let value = try? container.decode(AlbumsResource.self) {
			...
			throw DecodingError.typeMismatch(
				...
				.init(
					...
					debugDescription: "Unable to decode instance of SearchresultsSingleDataDocumentIncludedInner"
				)
			)
		}
	}
