...
internal class OfflineTasksAPI {
    ...
    internal class func offlineTasksGet(pageCursor: String? = nil, include: [String]? = nil, filterInstallationId: [String]? = nil) async throws -> OfflineTasksMultiResourceDataDocument {
        do {
            return try await offlineTasksGetWithRequestBuilder(pageCursor: pageCursor, include: include, filterInstallationId: filterInstallationId).execute().body
     ...
     */
    internal class func offlineTasksGetWithRequestBuilder(pageCursor: String? = nil, include: [String]? = nil, filterInstallationId: [String]? = nil) -> RequestBuilder<OfflineTasksMultiResourceDataDocument> {
