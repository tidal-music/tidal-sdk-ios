...
internal class SearchSuggestionsAPI {
    ...
    internal class func searchSuggestionsIdGet(id: String, countryCode: String, include: [String]? = nil) async throws -> SearchSuggestionsSingleDataDocument {
        return try await searchSuggestionsIdGetWithRequestBuilder(id: id, countryCode: countryCode, include: include).execute().body
    }
     ...
     */
    internal class func searchSuggestionsIdGetWithRequestBuilder(id: String, countryCode: String, include: [String]? = nil) -> RequestBuilder<SearchSuggestionsSingleDataDocument> {
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    internal class func searchSuggestionsIdRelationshipsDirectHitsGet(id: String, countryCode: String, include: [String]? = nil, pageCursor: String? = nil) async throws -> SearchSuggestionsMultiDataRelationshipDocument {
        return try await searchSuggestionsIdRelationshipsDirectHitsGetWithRequestBuilder(id: id, countryCode: countryCode, include: include, pageCursor: pageCursor).execute().body
    }
     ...
     */
    internal class func searchSuggestionsIdRelationshipsDirectHitsGetWithRequestBuilder(id: String, countryCode: String, include: [String]? = nil, pageCursor: String? = nil) -> RequestBuilder<SearchSuggestionsMultiDataRelationshipDocument> {
