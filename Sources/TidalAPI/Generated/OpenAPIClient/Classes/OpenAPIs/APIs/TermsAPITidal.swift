...
public enum TermsAPITidal {
     ...
     */
	public static func termsGet(filterCountryCode: [String]? = nil, filterIsLatestVersion: [String]? = nil, filterTermsType: [TermsAPITidal.FilterTermsType_termsGet]? = nil) async throws -> TermsMultiResourceDataDocument {
		return try await RequestHelper.createRequest {
			TermsAPI.termsGetWithRequestBuilder(filterCountryCode: filterCountryCode, filterIsLatestVersion: filterIsLatestVersion, filterTermsType: filterTermsType?.compactMap { $0.toTermsAPIEnum() })
		}
	}
