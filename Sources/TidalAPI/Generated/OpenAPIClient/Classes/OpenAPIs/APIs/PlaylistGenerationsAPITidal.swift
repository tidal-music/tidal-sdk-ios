...
public enum PlaylistGenerationsAPITidal {
     ...
     */
	public static func playlistGenerationsIdRelationshipsPlaylistGet(id: String, include: [String]? = nil, replaceMedia: String? = nil) async throws -> PlaylistGenerationsSingleRelationshipDataDocument {
		return try await RequestHelper.createRequest {
