...
public enum SearchResultsAPITidal {
     ...
     */
	public static func searchResultsIdGet(id: String, countryCode: String, explicitFilter: String? = nil, include: [String]? = nil) async throws -> SearchResultsSingleDataDocument {
     ...
     */
	public static func searchResultsIdRelationshipsAlbumsGet(id: String, countryCode: String, explicitFilter: String? = nil, include: [String]? = nil, pageCursor: String? = nil) async throws -> SearchResultsMultiDataRelationshipDocument {
		return try await RequestHelper.createRequest {
	...
	/**
     ...
     - returns: SearchResultsMultiDataRelationshipDocument
     */
	public static func searchResultsIdRelationshipsArtistsGet(id: String, countryCode: String, explicitFilter: String? = nil, include: [String]? = nil, pageCursor: String? = nil) async throws -> SearchResultsMultiDataRelationshipDocument {
		return try await RequestHelper.createRequest {
	...
	/**
     ...
     - returns: SearchResultsMultiDataRelationshipDocument
     */
	public static func searchResultsIdRelationshipsPlaylistsGet(id: String, countryCode: String, explicitFilter: String? = nil, include: [String]? = nil, pageCursor: String? = nil) async throws -> SearchResultsMultiDataRelationshipDocument {
		return try await RequestHelper.createRequest {
	...
	/**
     ...
     - returns: SearchResultsMultiDataRelationshipDocument
     */
	public static func searchResultsIdRelationshipsTopHitsGet(id: String, countryCode: String, explicitFilter: String? = nil, include: [String]? = nil, pageCursor: String? = nil) async throws -> SearchResultsMultiDataRelationshipDocument {
		return try await RequestHelper.createRequest {
	...
	/**
     ...
     - returns: SearchResultsMultiDataRelationshipDocument
     */
	public static func searchResultsIdRelationshipsTracksGet(id: String, countryCode: String, explicitFilter: String? = nil, include: [String]? = nil, pageCursor: String? = nil) async throws -> SearchResultsMultiDataRelationshipDocument {
		return try await RequestHelper.createRequest {
	...
	/**
     ...
     - returns: SearchResultsMultiDataRelationshipDocument
     */
	public static func searchResultsIdRelationshipsVideosGet(id: String, countryCode: String, explicitFilter: String? = nil, include: [String]? = nil, pageCursor: String? = nil) async throws -> SearchResultsMultiDataRelationshipDocument {
		return try await RequestHelper.createRequest {
