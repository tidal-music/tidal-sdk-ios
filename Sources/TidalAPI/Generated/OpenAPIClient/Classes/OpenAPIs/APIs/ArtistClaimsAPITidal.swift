...
public enum ArtistClaimsAPITidal {
	...
	/**
     ...
     - returns: 
     */
	public static func artistClaimsIdPatch(artistClaimsUpdateOperationPayload: ArtistClaimsUpdateOperationPayload? = nil) async throws {
		return try await RequestHelper.createRequest {
			ArtistClaimsAPI.artistClaimsIdPatchWithRequestBuilder(artistClaimsUpdateOperationPayload: artistClaimsUpdateOperationPayload)
		}
	}
