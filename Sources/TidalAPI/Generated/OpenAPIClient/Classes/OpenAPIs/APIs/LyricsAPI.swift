...
internal class LyricsAPI {
    ...
    internal class func lyricsIdDelete(id: String, idempotencyKey: String? = nil) async throws -> MutationResponseDocument {
        do {
     ...
     */
    internal class func lyricsIdDeleteWithRequestBuilder(id: String, idempotencyKey: String? = nil) -> RequestBuilder<MutationResponseDocument> {
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    internal class func lyricsIdPatch(id: String, idempotencyKey: String? = nil, lyricsUpdateOperationPayload: LyricsUpdateOperationPayload? = nil) async throws -> MutationResponseDocument {
        do {
    ...
    /**
     ...
     - returns: RequestBuilder<MutationResponseDocument> 
     */
    internal class func lyricsIdPatchWithRequestBuilder(id: String, idempotencyKey: String? = nil, lyricsUpdateOperationPayload: LyricsUpdateOperationPayload? = nil) -> RequestBuilder<MutationResponseDocument> {
        var localVariablePath = "/lyrics/{id}"
        let idPreEscape = "\(APIHelper.mapValueToPathItem(id))"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    internal class func lyricsIdRelationshipsOwnersGet(id: String, include: [String]? = nil, pageCursor: String? = nil) async throws -> LyricsOwnersMultiRelationshipDataDocument {
        do {
            return try await lyricsIdRelationshipsOwnersGetWithRequestBuilder(id: id, include: include, pageCursor: pageCursor).execute().body
        } catch let httpError as HTTPErrorResponse {
            throw ErrorResponse.fromHTTPError(httpError)
        }
        // URLError and other errors propagate as-is
     ...
     */
    internal class func lyricsIdRelationshipsOwnersGetWithRequestBuilder(id: String, include: [String]? = nil, pageCursor: String? = nil) -> RequestBuilder<LyricsOwnersMultiRelationshipDataDocument> {
        ...
        let localVariableRequestBuilder: RequestBuilder<LyricsOwnersMultiRelationshipDataDocument>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    internal class func lyricsIdRelationshipsTrackGet(id: String, countryCode: String? = nil, include: [String]? = nil, replaceMedia: String? = nil) async throws -> LyricsTrackSingleRelationshipDataDocument {
        do {
     ...
     */
    internal class func lyricsIdRelationshipsTrackGetWithRequestBuilder(id: String, countryCode: String? = nil, include: [String]? = nil, replaceMedia: String? = nil) -> RequestBuilder<LyricsTrackSingleRelationshipDataDocument> {
        ...
        let localVariableRequestBuilder: RequestBuilder<LyricsTrackSingleRelationshipDataDocument>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
