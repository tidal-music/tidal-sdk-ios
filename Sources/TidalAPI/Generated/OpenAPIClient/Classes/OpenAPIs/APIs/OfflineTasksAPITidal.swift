...
public enum OfflineTasksAPITidal {
     ...
     */
	public static func offlineTasksGet(pageCursor: String? = nil, include: [String]? = nil, filterInstallationId: [String]? = nil) async throws -> OfflineTasksMultiResourceDataDocument {
		return try await RequestHelper.createRequest {
			OfflineTasksAPI.offlineTasksGetWithRequestBuilder(pageCursor: pageCursor, include: include, filterInstallationId: filterInstallationId)
		}
	}
