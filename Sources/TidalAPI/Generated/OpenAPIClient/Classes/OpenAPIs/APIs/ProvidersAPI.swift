...
internal class ProvidersAPI {
    ...
    internal class func getProviderById(id: String, include: [String]? = nil) async throws -> ProvidersSingleDataDocument {
        return try await getProviderByIdWithRequestBuilder(id: id, include: include).execute().body
    }
     ...
     */
    internal class func getProviderByIdWithRequestBuilder(id: String, include: [String]? = nil) -> RequestBuilder<ProvidersSingleDataDocument> {
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    internal class func getProvidersByFilters(include: [String]? = nil, filterId: [String]? = nil) async throws -> ProvidersMultiDataDocument {
        return try await getProvidersByFiltersWithRequestBuilder(include: include, filterId: filterId).execute().body
    }
     ...
     */
    internal class func getProvidersByFiltersWithRequestBuilder(include: [String]? = nil, filterId: [String]? = nil) -> RequestBuilder<ProvidersMultiDataDocument> {
