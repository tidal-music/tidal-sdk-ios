...
public enum VideosAPITidal {
	...
	public static func getVideoAlbumsRelationship(
		id: String,
		countryCode: String,
		include: [String]? = nil,
		...
		try await RequestHelper.createRequest {
			VideosAPI.getVideoAlbumsRelationshipWithRequestBuilder(
				id: id,
	...
	///
	/// - returns: VideosMultiDataRelationshipDocument
	public static func getVideoArtistsRelationship(
		id: String,
		countryCode: String,
		include: [String]? = nil,
		pageCursor: String? = nil
		...
		try await RequestHelper.createRequest {
			VideosAPI.getVideoArtistsRelationshipWithRequestBuilder(
				id: id,
				countryCode: countryCode,
				include: include,
				pageCursor: pageCursor
	...
	public static func getVideoById(
		id: String,
		countryCode: String,
		include: [String]? = nil
	) async throws -> VideosSingleDataDocument {
		try await RequestHelper.createRequest {
	...
	///
	/// - returns: VideosMultiDataRelationshipDocument
	public static func getVideoProvidersRelationship(
		id: String,
		countryCode: String,
		include: [String]? = nil,
		pageCursor: String? = nil
		...
		try await RequestHelper.createRequest {
			VideosAPI.getVideoProvidersRelationshipWithRequestBuilder(
				id: id,
				countryCode: countryCode,
				include: include,
				pageCursor: pageCursor
	...
	public static func getVideosByFilters(
		countryCode: String,
		include: [String]? = nil,
		filterId: [String]? = nil,
		...
		try await RequestHelper.createRequest {
			VideosAPI.getVideosByFiltersWithRequestBuilder(
				countryCode: countryCode,
				include: include,
				filterId: filterId,
