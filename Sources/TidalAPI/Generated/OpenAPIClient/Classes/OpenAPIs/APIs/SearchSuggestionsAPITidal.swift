...
public enum SearchSuggestionsAPITidal {
     ...
     */
	public static func searchSuggestionsIdGet(id: String, countryCode: String, explicitFilter: String? = nil, include: [String]? = nil) async throws -> SearchSuggestionsSingleDataDocument {
     ...
     */
	public static func searchSuggestionsIdRelationshipsDirectHitsGet(id: String, countryCode: String, explicitFilter: String? = nil, include: [String]? = nil, pageCursor: String? = nil) async throws -> SearchSuggestionsMultiDataRelationshipDocument {
		return try await RequestHelper.createRequest {
