...
```swift
    open class func userCollectionAlbumsIdRelationshipsItemsPost(id: String, countryCode: String? = nil, idempotencyKey: String? = nil, userCollectionAlbumsItemsRelationshipAddOperationPayload: UserCollectionAlbumsItemsRelationshipAddOperationPayload? = nil, completion: @escaping (_ data: UserCollectionAlbumsItemsAddMultiRelationshipDataDocument?, _ error: Error?) -> Void)
```
