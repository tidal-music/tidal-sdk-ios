//
// SearchResultsTopHitsRelationshipDocumentIncludedInner.swift
//
...
public enum SearchResultsTopHitsRelationshipDocumentIncludedInner: Codable, JSONEncodable, Hashable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        if let value = try? container.decode(AlbumsResource.self) {
            ...
            throw DecodingError.typeMismatch(Self.Type.self, .init(codingPath: decoder.codingPath, debugDescription: "Unable to decode instance of SearchResultsTopHitsRelationshipDocumentIncludedInner"))
        }
    }
}
